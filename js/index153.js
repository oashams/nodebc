...
console.log (arithmeticValue.add(2, 10));
console.log (arithmeticValue.subtract(10, 5));
console.log (arithmeticValue.multiply(3, 100));
console.log (arithmeticValue.divide(40, 2));
console.log (arithmeticValue.remainder(20, 2));
